# @featuretrace:financial_integration_v2 — Unit tests for CsvUploadBankFeed (mock CSV/OFX/QIF bank feed).
# Layer: test
# Tests: backend/integrations/mocks/csv_upload_bank_feed.py
"""
...
from integrations.mocks.csv_upload_bank_feed import (
    CsvUploadBankFeed,
...
def _build_valid_crn(scheme: str = "016244", lot: str = "005", inst: str = "001") -> str:
    from integrations.mocks.mock_biller import build_crn
