# @featuretrace:demo-seed — Invariants + idempotency tests for the demo scheme seed.
# Layer: test
# Tests: backend/seeds/demo_scheme.py
...
async def db_session():
    ...
    from seeds.demo_scheme import DEMO_TENANT_ID
