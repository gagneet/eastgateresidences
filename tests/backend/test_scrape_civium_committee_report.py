# @featuretrace:strata_sync — Unit tests for scrape_civium_committee_report.py's pure functions.
# Layer: test
# Tests: backend/scripts/scrape_civium_committee_report.py
"""Unit tests for the standalone Civium scraper's pure functions.

Run:  python3 -m pytest test_scrape_civium_committee_report.py -q
(pure functions only — no browser, no network, no portal access needed)
"""
from scripts.scrape_civium_committee_report import (
    enrich_money_fields,
    normalize_table,
    parse_money,
)
