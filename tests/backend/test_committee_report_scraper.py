# @featuretrace:strata_sync — Unit tests for committee_report_scraper.py's parsing/normalisation helpers.
# Layer: test
# Tests: backend/scripts/committee_report_scraper.py
from scripts.committee_report_scraper import (
    enrich_money_fields,
    normalize_table,
    parse_money,
)
