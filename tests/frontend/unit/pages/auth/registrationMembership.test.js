 ...
 *
 * Run: cd frontend && npx jest --testPathPatterns=registrationMembership
 *
 * Location note: this file lived at tests/frontend/test_registration_membership.test.js
 * until 2026-08-20, where NO runner executed it. Jest's testMatch is scoped to
 * tests/frontend/unit/ so it was out of scope there, and playwright's testIgnore
 * excludes .test.js files so it was skipped there too. It has been moved under
 * tests/frontend/unit/ so that it actually runs. Keep jest unit tests inside
 * tests/frontend/unit/; anything outside it is silently dead coverage.
 */
