// @featuretrace:strata_sync — Strata Portal Sync UI: start browser scrape, submit PIN, preview, confirm/discard.
// Layer: frontend
// Data flow: this page -> GET /strata/sync/latest, POST /strata/sync/start, POST /strata/sync/pin,
//            GET /strata/sync/status/{id}, POST /strata/sync/preview/confirm -> backend/routers/strata_sync.py (global job).
// Related: backend/routers/strata_sync.py
//           backend/scripts/run_scraper.py
//           frontend/src/app/(app)/admin/strata-sync/page.tsx
...
/**
 * Strata Portal Sync admin page: start a browser-scrape job, submit the portal's one-time
 * PIN when prompted, review the scraped preview, then confirm (writes to
 * levy_categories/annual_levies/unit_levy_ledger) or discard. Polls
 * GET /strata/sync/status/{id} while a job is in flight.
 */
