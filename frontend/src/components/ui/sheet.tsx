...
const sheetVariants = cva(
    "fixed z-50 gap-4 overflow-y-auto overflow-x-hidden bg-background p-4 shadow-lg transition ease-in-out [-webkit-overflow-scrolling:touch] sm:p-6 data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
    {
        variants: {
            side: {
