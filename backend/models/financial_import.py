# @featuretrace:levy — Pydantic request/response schemas for the Financial Year CSV Upload feature.
# Layer: model
# Data flow: routers/financial_import.py request bodies / responses ↔ services/financial_import_service.py.
