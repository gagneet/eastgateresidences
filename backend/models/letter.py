...
TEMPLATE_SCHEMAS = {
    ...
    "agm_invitation": {
        ...
        "description": "Formal AGM notice with venue, online access, quorum guidance and agenda",
        "fields": [
            {"name": "owner_name", "type": "string", "required": True, "label": "Owner Name"},
            ...
            {"name": "agm_location", "type": "string", "required": True, "label": "Venue / Location"},
            {"name": "meeting_link", "type": "string", "required": False, "label": "Online Meeting Link"},
            {"name": "meeting_id", "type": "string", "required": False, "label": "Meeting ID"},
            {"name": "meeting_passcode", "type": "string", "required": False, "label": "Meeting Passcode"},
            {"name": "manager_name", "type": "string", "required": False, "label": "Strata Manager Name"},
            {"name": "quorum_text", "type": "textarea", "required": False, "label": "Quorum and Voting Guidance"},
