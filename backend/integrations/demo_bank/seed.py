...
Acme Demo (UPDEMO5): 2 years of synthetic demo transactions (14 lots).
"""
...
async def seed_east_gate(
    ...
    """
    from integrations.demo_bank.ingestion import ensure_account, _upsert_transaction, _recompute_balance
