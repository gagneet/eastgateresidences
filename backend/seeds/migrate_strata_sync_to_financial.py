#!/usr/bin/env python3
# @featuretrace:strata_sync — One-time bridge: strata_financials/strata_owners → levy accounting collections.
# Layer: migration
# Data flow: cd backend && venv/bin/python3 seeds/migrate_strata_sync_to_financial.py
#            → strata_financials / strata_owners → levy_categories / annual_levies / unit_levy_ledger (building-scoped).
# Related: backend/routers/strata_sync.py (ongoing equivalent bridge, this script is the historical catch-up)
# Collection: strata_financials, strata_owners, levy_categories, annual_levies, unit_levy_ledger
"""
